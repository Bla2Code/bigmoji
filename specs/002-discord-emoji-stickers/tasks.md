...
## Phase 6: User Story 4 - Default Sticker Set Available on First Use (Priority: P3)

**Goal**: Provide built-in defaults for popular emojis and ensure first-use availability per guild.

**Independent Test**: For a new guild with no mappings, verify default stickers are initialized and single-emoji messages for default set are replaced.
...
- **US4 (P3)**: starts after Foundational; depends on storage/repository/service infrastructure and integrates with US1 runtime flow
...
4. Deliver US4 (default first-use onboarding)
